 ...
 * ApiExceptions and its subclasses represents the errors returns by api.
 * Status field returned in api response is used to identify its corresponding exception.Represent errors returned by Api as part of response
 */
